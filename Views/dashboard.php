...
<title>Dashboard | Barbearia Vinicius</title>
      ...
      <section class="page active" id="page-dashboard">
        ...
        <div class="cards cards-3">
          <div class="card">
            ...
            <div class="card-value in" id="periodIn">R$ 0,00</div>
            <div class="card-sub" id="subIn">0 lançamentos</div>
          </div>
          <div class="card">
            <div class="card-label" id="lblOut">Saídas</div>
            <div class="card-value out" id="periodOut">R$ 0,00</div>
            <div class="card-sub" id="subOut">0 lançamentos</div>
          </div>
          <div class="card highlight">
            <div class="card-label" id="lblProfit">Lucro</div>
            <div class="card-value" id="periodProfit">R$ 0,00</div>
